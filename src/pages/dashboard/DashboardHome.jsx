...
function DashboardHome() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-[32px] border border-stone-200/70 bg-gradient-to-br from-stone-50 via-white to-amber-50 p-5 shadow-xl shadow-stone-900/5 sm:p-8">
        <div className="flex flex-col gap-8 xl:flex-row xl:items-start xl:justify-between">
          ...
          <Link
            to="/dashboard/posts"
            className="inline-flex w-full items-center justify-center rounded-2xl bg-stone-900 px-5 py-3 text-sm font-medium text-white shadow-lg shadow-stone-900/10 transition duration-200 hover:-translate-y-0.5 hover:bg-amber-700 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-amber-100 sm:w-auto"
          >
            Create Post
          </Link>
        </div>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <Link
          ...
          className="group rounded-[28px] border border-stone-200/70 bg-white p-5 shadow-lg shadow-stone-900/5 transition duration-200 hover:-translate-y-1 hover:shadow-xl hover:shadow-stone-900/10 focus:outline-none focus:ring-4 focus:ring-amber-100 sm:p-6"
        >
